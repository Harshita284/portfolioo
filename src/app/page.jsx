...
export default function AboutUs() {
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
    ...
    {renderKeys('mobileApps', 'Mobile Apps')}
      ...
      <div className='m-4 w-full max-w-[1500px] h-[100px] p-3'>
        <h1 className='text-3xl sm:text-2xl text-yellow-800 font-extrabold text-ehitr text-center'>
          Our Portfolio
        </h1>
      ...
      <div className='px-4 sm:px-8 py-10 space-y-8'>
        ...
        <div className='flex justify-center gap-2 mt-8'>
          {Array.from({ length: getTotalPages(currentCategory === 'all' ? 
            categorizedData.managementSystems.concat(categorizedData.businessSystems, categorizedData.websites) : 
            categorizedData[currentCategory] || []) 
          }).map((_, idx) => (
            <button
